    ...
    <div className="w-full max-w-md mx-auto p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center">
          ...
          <label htmlFor="terms" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
            I agree to the{" "}
            <Link href="/terms-of-service" className="font-medium text-burgundy-600 hover:text-burgundy-500 dark:text-burgundy-400">
              Terms of Service
            </Link>{" "}
            and{" "}
            <Link href="/privacy-policy" className="font-medium text-burgundy-600 hover:text-burgundy-500 dark:text-burgundy-400">
              Privacy Policy
            </Link>
          </label>
        </div>
        ...
        <div>
          <Button
            ...
            disabled={isLoading}
            variant="primary"
            className="w-full bg-gradient-to-r from-[#800020] to-[#600010] hover:from-[#900030] hover:to-[#700020] py-3 text-base"
          >
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <Link href="/auth/login" className="font-medium text-burgundy-600 hover:text-burgundy-500 dark:text-burgundy-400">
            Sign in
          </Link>
        </p>
      </div>
